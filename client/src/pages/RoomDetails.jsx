...
const RoomDetails = () => {
  ...
  return room &&(
    <div className='py-28 md:py-32 md:px-16 lg:px-24 xl:px-32'>
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>
            Guests will be allocated on the ground floor according to avialability. You get a comfortable two bedroom apartment has true city feeling. The  price quoted is for two guest, at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according to availability. You get the comfortable two bedroom apartment that has a true feeling.
        </p>
    </div>
        {/* Hosted By */}
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                ...
                <div>
                    <p className='text-lg md:text-xl'>Hostede By {room.hotel.name}</p>
